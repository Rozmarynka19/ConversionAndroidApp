...
public class VolActivity extends AppCompatActivity {
    ...
    String[] stringArray;
    double[] unitMultipliers = {1000000000,1,0.001,0.000001};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.vol_units, android.R.layout.simple_spinner_item);
        ...
        stringArray = getResources().getStringArray(R.array.vol_units);
